    ...
    return (
      ...
      >
        ...
        <i>
          <h5>Our Vision</h5>
          <p>
            GetEasyTech is a leader in transforming information-based services enabling
          ...
          <p>
            ...
            As well, you are expected to understand your obligations under GetEasyTech
            ...
            form. Those of us who fail to abide by the Code and GetEasyTech's policies
          ...
          <p>
            It is the responsibility of everybody at GetEasyTech to report any known or
            ...
            corporation.. GetEasyTech is committed to protecting all Employees who
          ...
          <p>
            Do not disclose information about GetEasyTech activities or our customers’
            activities to non-authorized Employees within the workplace, or
            anyone outside the workplace unless in accordance with GetEasyTech's
            Disclosure Policy.All information held by GetEasyTech is confidential and
            the property of GetEasyTech. This includes information relating to GetEasyTech
          ...
          <p>
            ...
            made to protect GetEasyTech's computer systems and associated software from
          ...
          <p>
            ...
            protecting funds.When spending GetEasyTech funds, ensure that GetEasyTech receives
            good value for the expenditure. Do not use GetEasyTech funds for personal
            benefit. Compliance with the International Financial Reporting
            Standards and internal controls is expected at all times, and GetEasyTech's
            books of account, reports, records and other documents must
            accurately account for and report all assets, liabilities and
            transactions affecting GetEasyTech
          </p>
          <hr />
          ...
          <p>
            ...
            very limited circumstances as part of GetEasyTech social or business
          ...
          <p>
            ...
            consult the Employee Privacy Policy which can be found on the GetEasyTech
