...
class ReportTemplate extends Component {
  ...
  <tr style={{border: '3px solid black', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact'}}>
    <td className="header-cell" id="header-cell" colspan="4" rowspan="4" style={{backgroundImage: `url(${demo})`, backgroundRepeat: "no-repeat", border: '3px solid black', backgroundPosition: 'right', backgroundSize: '250px', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact'}}>
